-- CentralDevelopment/Central-UI/tree/main

# Central Library
This documentation is for the stable release of Central Library.

## Booting the Library
```lua
local CentralLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/CentralDevelopment/Central-UI/tree/main/source')))()
```
...
## Creating a Window
```lua
local Window = CentralLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "CentralTest"})
...
print(CentralLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
